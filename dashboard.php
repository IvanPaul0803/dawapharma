...
$countLowStock1 = $lowStockQuery1->num_rows;
    ...
    $lowStockSql3 = "SELECT * FROM expired_drugs";
    $lowStockQuery3 = $connect->query($lowStockSql3);
    $countLowStock3 = ($lowStockQuery3 && $lowStockQuery3->num_rows > 0) ? $lowStockQuery3->num_rows : 0;
                   ...
                   <div class="col-md-6 dashboard">
                      <div class="card" style="    background-color: #FFBC11 ">
                          ...
                          <h2 class="color-white"><?php echo $countLowStock3; ?></h2>
                                  <a href="list-expiring-drugs.php"><p class="m-b-0">Total Expired Medicine</p></a>
                              </div>
                          </div>
                      </div>
                  </div>
