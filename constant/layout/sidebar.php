                    ...
                    <?php if(isset($_SESSION['userId']) && $_SESSION['userId']==1) { ?>
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-medkit"></i><span class="hide-menu">Medicine</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="list-expiring-drugs.php">Expiring Drugs</a></li>
                            </ul>
                        </li>
                    <?php }?>
                    <?php if(isset($_SESSION['userId']) && $_SESSION['userId']==1) { ?>
                        <li> <a href="inventory.php" aria-expanded="false"><i class="fa fa-cubes"></i><span class="hide-menu">Inventory</span></a>
                        </li>
                    <?php }?>
...
<li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-flag"></i><span class="hide-menu">Reports</span></a>
                           ...
                           <li><a href="sales_report.php">Sales Report</a></li>
                                ...
                                <li><a href="list-expiring-drugs.php">Expiring Drugs List</a></li>
                            </ul>
                        </li>
                  <?php }?>
